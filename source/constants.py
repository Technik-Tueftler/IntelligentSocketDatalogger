...
USER_MESSAGE_INLINE_KEYBOARD_DEVICE = "Please select device:"
USER_MESSAGE_INLINE_KEYBOARD_SWITCH_DEVICE_OFF = "Please select the device you wish to switch off:"
USER_MESSAGE_INLINE_KEYBOARD_SWITCH_DEVICE_ON = "Please select the device you wish to switch on:"
...
DEVICE_SWITCH_STATUS_UPDATE_TIME = 60
